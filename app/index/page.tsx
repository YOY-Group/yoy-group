    ...
    <main className="mx-auto max-w-3xl px-6 py-24">
      <header className="space-y-4">
        ...
        <p className="text-base leading-relaxed text-muted-foreground">
          This page is a public log of YOY.Group’s operating work.
          <br />
      ...
      <section aria-label="Index issues" className="space-y-6">
        <div className="space-y-2">
          <h2 className="text-sm font-medium tracking-tight">Issues</h2>
          <p className="text-sm leading-relaxed text-muted-foreground">
            Quarterly (and occasional annual) snapshots. Each issue is a bounded
      ...
      <footer className="mt-16 text-xs text-muted-foreground">
        Index is updated deliberately, not frequently.
      </footer>
    </main>
  );
}